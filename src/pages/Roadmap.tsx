...
const icon = (s: string) => s === 'done' ? <CheckCircle2 className="h-4 w-4 text-success" /> : s === 'in' ? <Loader2 className="h-4 w-4 text-warning animate-spin" /> : <Circle className="h-4 w-4 text-muted-foreground" />;
