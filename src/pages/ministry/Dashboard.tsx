...
export default function MinistryDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-heading font-bold">National Dashboard</h1>
        <p className="text-muted-foreground">
          Ministry of Education — National overview and analytics
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="font-heading">National Overview</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-sm">
              National analytics charts, province comparison, and trend visualization will appear here.
            </p>
          </CardContent>
        </Card>
        <Card>
