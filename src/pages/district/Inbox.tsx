...
/**
 * Verification Inbox — unified replacement for the old /district/verify and
 * /district/submissions pages. Filters are persisted in URL search params so
 * the back button and shareable links work.
 */
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            تمام ارسال‌های مکاتب ولسوالی {profile?.district} — مرور، فیلتر و تأیید
          </p>
        </div>
      </div>
