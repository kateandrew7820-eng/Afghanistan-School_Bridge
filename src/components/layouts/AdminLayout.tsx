...
import { 
  LayoutDashboard, School, BarChart3, Bell, FileUp,
  Calendar, LogOut, Building2, Menu, X, User
} from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
          <div className="h-14 flex items-center gap-3 px-4 border-b">
            ...
            <div className="truncate">
              <span className="font-heading font-bold text-sm block truncate">{t('admin.dashboardTitle')}</span>
